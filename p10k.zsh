# Generated by Powerlevel10k configuration wizard on 2023-03-21 at 21:29 CST.
...
# 2 lines, dotted, dark-ornaments, sparse, fluent, instant_prompt=off.
...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE="%n@`hostname -f`"
